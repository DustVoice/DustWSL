...
Mandatory or strongly suggested packages (**Required**) are separated from optional (**Optional**) ones,
as well as regular packages (puzzle symbol) from AUR (external symbol) ones.
