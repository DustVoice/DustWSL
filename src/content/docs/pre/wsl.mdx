...
As we will install [a different distro](./archwsl.md) than the default (Ubuntu) in a second anyway,
...
<Aside type="caution">
  For [WSLg](https://github.com/microsoft/wslg) to work properly, you need to
  make sure you're running Windows 11, or the minimum required version of
...
<Aside>
  This should only be neccessary if your Windows is locked down, the Microsoft
  Store is disabled, or similar.
</Aside>
