...
Despite me currently trying out Aura, I might choose to switch back to Paru,
as I've used Paru for way longer than Aura and am used to the workflow, etc.
...
See the [relevant Arck Wiki section](https://wiki.archlinux.org/title/AUR_helpers#Pacman_wrappers)
for further information and comparison between helpers.

</Aside>

<Aside title="Why I'm using Aura">
