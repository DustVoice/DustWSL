...
To properly utilize my `nu` setup, I need to have the `starship`, `zoxide` and `jj` commands available.

<Aside>

If you installed `jj` in the [Dotfiles Prerequisites](./dotpre) chapter, you
can omit it here.
